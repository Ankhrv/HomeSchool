import l from './Kabped.module.css';
...
// import l from '../../../Components/BesplZan/M.module.css';
...
<Helmet>
       ...
       <Link to="/" style={linkStyle}>   <span className={l.navi2}>Главная</span></Link><span className={l.navi3}>&gt;</span><span className={l.navi4}>Кабинет педагога</span></div> 
...
<div className={l.uii}>Я отвечу Вам в ближайшее время</div>
